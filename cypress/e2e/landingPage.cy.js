describe('Root Page', () => {
  ...
  context('Header section', () => {
    ...
    it('Displays the dropdown menu when at mobile size', () => {
      cy.viewport('iphone-6+');
      cy.getByData('menu-icon').click();
      cy.getByData('dropdown-menu').should('be.visible');
      cy.getByData('dropdown-menu').find('a').contains('API');
      cy.getByData('dropdown-menu').find('a').contains('Help');
      cy.getByData('dropdown-menu').find('a').contains('Login');
      cy.getByData('dropdown-menu').find('button').contains('Sign Up');
    });
